...
public class MultiImageView extends LinearLayout {
    ...
    private int pxOneMaxWandH;//单张图最大允许高度
    private int pxMoreWandH;//多张图的宽高
    private int pxImagePadding = ContextUtils.dip2px(getContext(), 3);
    ...
    private void initImageLayoutParams() {
        ...
        moreParaColumnFirst = new LayoutParams(pxOneMaxWandH, pxMoreWandH);
